...
public:
    ...
    const static sc2::UNIT_TYPEID FOOD_USED = static_cast<sc2::UNIT_TYPEID>(526);
    const static sc2::UNIT_TYPEID FOOD_CAP = static_cast<sc2::UNIT_TYPEID>(527);

    // Multi-representation units/structures
    const static sc2::UNIT_TYPEID TERRAN_ANY_COMMANDCENTER = static_cast<sc2::UNIT_TYPEID>(528);
    const static sc2::UNIT_TYPEID TERRAN_ANY_BARRACKS = static_cast<sc2::UNIT_TYPEID>(529);
    const static sc2::UNIT_TYPEID TERRAN_ANY_FACTORY = static_cast<sc2::UNIT_TYPEID>(530);
    const static sc2::UNIT_TYPEID TERRAN_ANY_STARPORT = static_cast<sc2::UNIT_TYPEID>(531);

    // How many new scv that can be produced
    const static sc2::UNIT_TYPEID TERRAN_TOWNHALL_SCV_MINERALS = static_cast<sc2::UNIT_TYPEID>(532);
    const static sc2::UNIT_TYPEID TERRAN_TOWNHALL_SCV_VESPENE = static_cast<sc2::UNIT_TYPEID>(533);
};
