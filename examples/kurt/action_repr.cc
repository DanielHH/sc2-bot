...
std::map<ACTION, ActionRepr> ActionRepr::values = {
    ...
    // Unit training
    { ACTION::TRAIN_SCV, ActionRepr({},{ {UNIT_FAKEID::TERRAN_TOWNHALL_SCV_MINERALS, 1}, { UNIT_FAKEID::MINERALS, 50 } },{ { UNIT_FAKEID::TERRAN_ANY_COMMANDCENTER, 1 } },{{UNIT_TYPEID::TERRAN_SCV, 1}, {UNIT_FAKEID::TERRAN_SCV_MINERALS, 1}}, 12) },
