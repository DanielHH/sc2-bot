...
std::map<ACTION, ActionRepr> ActionRepr::values = {
    ...
    { ACTION::BUILD_REFINERY, ActionRepr({},{{UNIT_FAKEID::MINERALS, 75}, {UNIT_TYPEID::NEUTRAL_VESPENEGEYSER, 1}},{{UNIT_FAKEID::TERRAN_SCV_MINERALS, 1}},{{UNIT_TYPEID::TERRAN_REFINERY, 1}, {UNIT_FAKEID::TERRAN_TOWNHALL_SCV_VESPENE, 3}}, 21) },
