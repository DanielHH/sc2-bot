...
std::map<ACTION, ActionRepr> ActionRepr::values = {
    ...
    { ACTION::BUILD_COMMAND_CENTER, ActionRepr({}, { { UNIT_FAKEID::MINERALS, 400 } }, { {UNIT_FAKEID::TERRAN_SCV_MINERALS, 1}}, { {UNIT_TYPEID::TERRAN_COMMANDCENTER, 1}, {UNIT_FAKEID::TERRAN_ANY_COMMANDCENTER, 1}, {UNIT_FAKEID::TERRAN_TOWNHALL_SCV_MINERALS, 16}, {UNIT_TYPEID::NEUTRAL_VESPENEGEYSER, 2}, {UNIT_FAKEID::FOOD_CAP, 15}}, 71) },
