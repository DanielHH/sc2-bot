...
std::map<ACTION, ActionRepr> ActionRepr::values = {
    ...
    { ACTION::BUILD_COMMAND_CENTER, ActionRepr({}, { { UNIT_FAKEID::MINERALS, 400 } }, { {UNIT_FAKEID::TERRAN_SCV_MINERALS, 1}}, { {UNIT_TYPEID::TERRAN_COMMANDCENTER, 1}, {UNIT_FAKEID::TERRAN_ANY_COMMANDCENTER, 1}, {UNIT_FAKEID::TERRAN_TOWNHALL_SCV_MINERALS, 16}, {UNIT_TYPEID::NEUTRAL_VESPENEGEYSER, 2}}, 71) },
    ...
    { ACTION::BUILD_REFINERY, ActionRepr({},{{UNIT_FAKEID::MINERALS, 75}, {UNIT_TYPEID::NEUTRAL_VESPENEGEYSER, 1}, {UNIT_FAKEID::TERRAN_SCV_MINERALS, 1}},{},{{UNIT_TYPEID::TERRAN_REFINERY, 1}, {UNIT_FAKEID::TERRAN_SCV_VESPENE, 1}, {UNIT_FAKEID::TERRAN_TOWNHALL_SCV_VESPENE, 2}}, 21) },
    ...
    // Unit training
    { ACTION::TRAIN_SCV, ActionRepr({},{ {UNIT_FAKEID::TERRAN_TOWNHALL_SCV_MINERALS, 1}, { UNIT_FAKEID::MINERALS, 50 } },{ { UNIT_FAKEID::TERRAN_ANY_COMMANDCENTER, 1 } },{ { UNIT_FAKEID::TERRAN_SCV_MINERALS, 1 } }, 12) },
